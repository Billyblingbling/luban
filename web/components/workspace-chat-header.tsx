...
export function WorkspaceChatHeader({
  ...
  return (
    <div className="flex items-center h-11 border-b border-border bg-background px-4">
          ...
          {isEditingBranch ? (
            ...
            <>
              ...
              {isBranchRenaming ? (
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 z-10 flex items-center gap-0.5 opacity-0 group-hover/branch:opacity-100 transition-opacity bg-background px-0.5">
                  {allowRenameButtons && (
                    <>
                      <button
                        onClick={() => {
